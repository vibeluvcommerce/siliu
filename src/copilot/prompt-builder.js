...
- hover 头像/按钮后，下拉菜单通常出现在其下方
- 如果头像在 y: 0.05，下拉菜单项通常在 y: 0.08-0.18 范围内
- 【必须】hover 后必须先 screenshot 查看当前状态，确认下拉菜单已显示且看清"个人中心"位置
- 【必须】根据截图中下拉菜单的实际位置点击，不要随意估计坐标
- 【禁止】点击 y > 0.25 的区域（肯定不在下拉菜单范围内）
- 【禁止】连续操作：hover → 立即 click，必须有 screenshot 确认步骤
