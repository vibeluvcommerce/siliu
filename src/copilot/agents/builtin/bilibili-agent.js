...
- 评论输入框: 坐标 (0.17, 0.75)，placeholder 为 "发一条友善的评论"
- 评论发送按钮: 蓝色 "发送" 文字按钮
...
- 标题输入框: 坐标 (0.37, 0.48)，click 聚焦后 type 输入标题
- 分区选择框: 坐标 (0.38, 0.62)，click 展开后需要 click + scroll 选择
  - 分区是级联选择器：先点击展开，然后点击大类（如"生活"），再点击子类
  - 不要使用 select 操作，使用两次 click
