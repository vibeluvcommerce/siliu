        ...
        (function() {
          ...
          function showSaveAgentDialog(coordinates, domain, url) {
            return new Promise((resolve) => {
              ...
              // SVG 图标（内嵌，从 Phosphor Icons 官方获取的准确路径）
              const icons = [
                ...
                { name: '工具', svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" style="width:20px;height:20px;"><path d="M128,64a40,40,0,1,0,40,40A40,40,0,0,0,128,64Zm0,64a24,24,0,1,1,24-24A24,24,0,0,1,128,128ZM112,168a8,8,0,0,0-8,8v16H80a8,8,0,0,0,0,16h24v16a8,8,0,0,0,16,0V192h24a8,8,0,0,0,0-16H112Zm104-48a8,8,0,0,0-8,8v16H184a8,8,0,0,0,0,16h24v16a8,8,0,0,0,16,0V144a8,8,0,0,0-8-8Z"/></svg>' },
